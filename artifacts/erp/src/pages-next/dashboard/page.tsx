...
import { dashboardService, salesService, type DashboardSummary, type RecentOrder } from '@/services';
import {
      ...
      <div className="space-y-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="rounded-2xl" style={{ backgroundColor: '#FFFFFF', border: '1.5px solid #EDE9FE', boxShadow: '0 1px 4px rgba(91,82,209,0.05)' }}>
              <div className="flex items-center justify-between px-5 py-4" style={{ borderBottom: '1px solid #EDE9FE' }}>
                ...
                <a href="/sales/orders" className="text-xs font-semibold flex items-center gap-1" style={{ color: '#5B52D1' }}>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl" style={{ backgroundColor: '#FFFFFF', border: '1.5px solid #EDE9FE', boxShadow: '0 1px 4px rgba(91,82,209,0.05)' }}>
              <div className="flex items-center justify-between px-5 py-4" style={{ borderBottom: '1px solid #EDE9FE' }}>
                ...
                <a href="/reports/sales?type=product" className="text-xs font-semibold" style={{ color: '#5B52D1' }}>Semua</a>
              </div>
        ...
        <div className="rounded-2xl" style={{ backgroundColor: '#FFFFFF', border: '1.5px solid #EDE9FE', boxShadow: '0 1px 4px rgba(91,82,209,0.05)' }}>
          <div className="flex items-center justify-between px-5 py-4" style={{ borderBottom: '1px solid #EDE9FE' }}>
            ...
            <a href="/settings/audit-log" className="text-xs font-semibold" style={{ color: '#5B52D1' }}>Lihat Audit Log</a>
          </div>
