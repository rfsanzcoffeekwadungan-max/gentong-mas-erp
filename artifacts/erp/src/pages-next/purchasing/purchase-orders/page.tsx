    ...
    <ModernLayout>
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => navigate('/purchasing/purchase-orders/new')} className="flex items-center gap-2 rounded-xl bg-orange-600 hover:bg-orange-500 px-4 py-2 text-sm font-medium text-white transition"><Plus className="h-4 w-4" /> Buat PO</button>
        </div>
        {stats && (
