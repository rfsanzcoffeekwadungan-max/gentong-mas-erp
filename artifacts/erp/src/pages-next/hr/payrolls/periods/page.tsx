                    ...
                    <tr key={p.id} style={{ borderBottom: '1px solid #f5f5f5' }}>
                      ...
                      <td style={{ padding: '14px 16px' }}>
                        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                          ...
                          <button onClick={() => navigate(`/hr/payrolls/slips?periodId=${p.id}`)} style={{ background: 'rgba(103,58,183,.1)', color: C, border: 'none', borderRadius: 6, padding: '6px 12px', fontSize: 12, fontWeight: 600, cursor: 'pointer' }}>Lihat Slip</button>
                        </div>
                      </td>
                    </tr>
                  );
