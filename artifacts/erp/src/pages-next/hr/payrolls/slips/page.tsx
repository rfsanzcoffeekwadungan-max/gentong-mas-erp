    ...
    <AppShell {...PAYROLL_CONFIG} navItems={PAYROLL_NAV}>
      <div style={{ padding: 32 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
          ...
          <button onClick={() => navigate('/hr/payrolls/periods')} style={{ display: 'flex', alignItems: 'center', gap: 8, background: C, color: '#fff', border: 'none', borderRadius: 8, padding: '10px 20px', fontWeight: 600, cursor: 'pointer' }}>
            Kelola Periode
          </button>
        </div>
